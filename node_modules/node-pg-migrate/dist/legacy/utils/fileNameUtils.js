...
//#region src/utils/fileNameUtils.ts
/**
...
function getNumericPrefix(filename, logger = console) {
	...
	if (prefix.length === 17) {
		...
		return (/* @__PURE__ */ new Date(`${year}-${month}-${date}T${hours}:${minutes}:${seconds}.${ms}Z`)).valueOf();
	}
	return value;
}
//#endregion
export { getNumericPrefix, getSuffixFromFileName };
