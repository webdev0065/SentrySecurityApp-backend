...
import { ClientBase, ClientConfig, QueryArrayConfig, QueryArrayResult, QueryConfig, QueryResult } from "pg";
...
//#endregion
//#region src/utils/escapeValue.d.ts
declare function escapeValue(val: Value): string | number;
//#endregion
//#region src/operations/functions/shared.d.ts
...
//#endregion
//#region src/operations/functions/dropFunction.d.ts
...
//#endregion
//#region src/operations/functions/createFunction.d.ts
...
//#endregion
//#region src/operations/functions/renameFunction.d.ts
...
type RunnerOption = RunnerOptionConfig & MigrationLoaderConfig & (RunnerOptionClient | RunnerOptionUrl);
/**
...
//#endregion
//#region src/utils/PgLiteral.d.ts
/**
...
//#endregion
//#region src/operations/tables/dropColumns.d.ts
...
//#endregion
//#region src/operations/sequences/shared.d.ts
...
//#endregion
//#region src/operations/sequences/alterSequence.d.ts
...
//#endregion
//#region src/operations/sequences/renameSequence.d.ts
...
//#endregion
//#region src/operations/tables/addColumns.d.ts
...
//#endregion
//#region src/operations/tables/dropConstraint.d.ts
...
//#endregion
//#region src/operations/tables/addConstraint.d.ts
...
//#endregion
//#region src/operations/tables/alterColumn.d.ts
...
//#endregion
//#region src/operations/tables/alterTable.d.ts
...
//#endregion
//#region src/operations/tables/renameColumn.d.ts
...
//#endregion
//#region src/operations/tables/renameConstraint.d.ts
...
//#endregion
//#region src/operations/domains/shared.d.ts
...
//#endregion
//#region src/operations/domains/alterDomain.d.ts
...
//#endregion
//#region src/operations/extensions/dropExtension.d.ts
...
//#endregion
//#region src/operations/extensions/createExtension.d.ts
...
//#endregion
//#region src/operations/grants/shared.d.ts
...
//#endregion
//#region src/operations/grants/revokeOnSchemas.d.ts
...
//#endregion
//#region src/operations/grants/grantOnSchemas.d.ts
...
//#endregion
//#region src/operations/grants/revokeOnTables.d.ts
...
//#endregion
//#region src/operations/grants/grantOnTables.d.ts
...
//#endregion
//#region src/operations/grants/revokeRoles.d.ts
...
//#endregion
//#region src/operations/grants/grantRoles.d.ts
...
//#endregion
//#region src/operations/indexes/shared.d.ts
...
//#endregion
//#region src/operations/indexes/dropIndex.d.ts
...
//#endregion
//#region src/operations/indexes/createIndex.d.ts
...
//#endregion
//#region src/operations/indexes/renameIndex.d.ts
type RenameIndexFn = (name: Name, newName: Name) => string;
type RenameIndex = Reversible<RenameIndexFn>;
//#endregion
//#region src/operations/materializedViews/shared.d.ts
type StorageParameters = {
  [key: string]: boolean | number;
};
//#endregion
//#region src/operations/materializedViews/alterMaterializedView.d.ts
...
//#endregion
//#region src/operations/materializedViews/dropMaterializedView.d.ts
...
//#endregion
//#region src/operations/materializedViews/createMaterializedView.d.ts
...
//#endregion
//#region src/operations/materializedViews/refreshMaterializedView.d.ts
...
//#endregion
//#region src/operations/materializedViews/renameMaterializedView.d.ts
...
//#endregion
//#region src/operations/materializedViews/renameMaterializedViewColumn.d.ts
...
//#endregion
//#region src/operations/operators/shared.d.ts
...
//#endregion
//#region src/operations/operators/addToOperatorFamily.d.ts
type AddToOperatorFamilyFn = (operatorFamilyName: Name, indexMethod: string, operatorList: OperatorListDefinition[]) => string;
type AddToOperatorFamily = Reversible<AddToOperatorFamilyFn>;
//#endregion
//#region src/operations/operators/dropOperator.d.ts
...
//#endregion
//#region src/operations/operators/createOperator.d.ts
...
//#endregion
//#region src/operations/operators/dropOperatorClass.d.ts
type DropOperatorClassOptions = DropOptions;
type DropOperatorClass = (operatorClassName: Name, indexMethod: string, dropOptions?: DropOperatorClassOptions) => string;
//#endregion
//#region src/operations/operators/createOperatorClass.d.ts
interface CreateOperatorClassOptions {
  default?: boolean;
  family?: string;
}
type CreateOperatorClassFn = (operatorClassName: Name, type: Type, indexMethod: string, operatorList: OperatorListDefinition[], operatorClassOptions: CreateOperatorClassOptions & DropOperatorClassOptions) => string;
type CreateOperatorClass = Reversible<CreateOperatorClassFn>;
//#endregion
//#region src/operations/operators/dropOperatorFamily.d.ts
type DropOperatorFamilyOptions = DropOptions;
type DropOperatorFamily = (operatorFamilyName: Name, indexMethod: string, dropOptions?: DropOperatorFamilyOptions) => string;
//#endregion
//#region src/operations/operators/createOperatorFamily.d.ts
interface CreateOperatorFamilyOptions {}
type CreateOperatorFamilyFn = (operatorFamilyName: Name, indexMethod: string, operatorFamilyOptions?: CreateOperatorFamilyOptions & DropOperatorFamilyOptions) => string;
type CreateOperatorFamily = Reversible<CreateOperatorFamilyFn>;
//#endregion
//#region src/operations/operators/removeFromOperatorFamily.d.ts
type RemoveFromOperatorFamily = (operatorFamilyName: Name, indexMethod: string, operatorList: OperatorListDefinition[]) => string;
//#endregion
//#region src/operations/operators/renameOperatorClass.d.ts
type RenameOperatorClassFn = (oldOperatorClassName: Name, indexMethod: string, newOperatorClassName: Name) => string;
type RenameOperatorClass = Reversible<RenameOperatorClassFn>;
//#endregion
//#region src/operations/operators/renameOperatorFamily.d.ts
type RenameOperatorFamilyFn = (oldOperatorFamilyName: Name, indexMethod: string, newOperatorFamilyName: Name) => string;
type RenameOperatorFamily = Reversible<RenameOperatorFamilyFn>;
//#endregion
//#region src/operations/policies/shared.d.ts
...
//#endregion
//#region src/operations/policies/alterPolicy.d.ts
type AlterPolicy = (tableName: Name, policyName: string, policyOptions: PolicyOptions) => string;
//#endregion
//#region src/operations/policies/dropPolicy.d.ts
...
//#endregion
//#region src/operations/policies/createPolicy.d.ts
...
//#endregion
//#region src/operations/policies/renamePolicy.d.ts
...
//#endregion
//#region src/operations/roles/shared.d.ts
...
//#endregion
//#region src/operations/triggers/shared.d.ts
...
//#endregion
//#region src/operations/triggers/createTrigger.d.ts
...
//#endregion
//#region src/operations/triggers/renameTrigger.d.ts
...
//#endregion
//#region src/operations/types/dropTypeAttribute.d.ts
...
//#endregion
//#region src/operations/types/addTypeAttribute.d.ts
...
//#endregion
//#region src/operations/types/addTypeValue.d.ts
...
//#endregion
//#region src/operations/types/renameTypeValue.d.ts
...
//#endregion
//#region src/operations/types/setTypeAttribute.d.ts
type SetTypeAttribute = (typeName: Name, attributeName: string, attributeType: Type) => string;
//#endregion
//#region src/operations/views/shared.d.ts
type ViewOptions = {
  [key: string]: boolean | number | string;
};
//#endregion
//#region src/operations/views/alterView.d.ts
...
//#endregion
//#region src/operations/views/alterViewColumn.d.ts
...
declare class MigrationBuilder {
   ...
   */
  readonly renameIndex: (...args: Parameters<RenameIndex>) => void;
  /**
